  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>BASE DE DATOS DE PQRS</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="homeAdmin.php">Home</a></li>
              <li class="breadcrumb-item">Ver PQRS</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Aqui encontrarás toda la informacion de las PQRS registradas, para su correspondiente gestión</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <?php
