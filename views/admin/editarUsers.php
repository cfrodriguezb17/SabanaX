        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="editarUsers.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Editar</p>
                </a>
              </li>
              ...
              <form action="../../../controller/insertarUserE.php" method="POST">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="tipodoc" required class="form-control" placeholder="Tipo Documento">
                  </div>
                  <div class="form-group">
                    <label>Nombres</label>
                  ...
                  <div class="form-group">
                    <label for="inputStatus">Rol</label>
                    <select name="rol" id="inputStatus" class="form-control custom-select">
                ...
                <button style= "background: #007bff;" type="submit" class="btn btn-primary btn-block">Registrar</button>
                </div>
              </form>
            </div>
        <!-- /.row -->
