          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Segun tu rol de usuario encontrarás en el menú de la parte izquierda las opciones que puedes realizar dentro del sistema</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body" style = "background: #343a40;">
                  <center>
                    <img src="../assets/dist/img/sabana.png" alt="" style="width: 50%;">
                  </center>
              </div>
              <!-- /.card-body -->
            </div>
