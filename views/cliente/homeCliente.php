	...
	<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
		  <div class="carousel-item active">
			<img src="../client-site/images/gallery/1.jpg" class="d-block w-100" alt="...">
...
<div class="container categorias">
	<div class="row cont-carousel-items">
		...
		<div onclick="redireccionarC('categoriasCliente.php#cine')" class="cat-filter col-md-4">
			<div class="card item">
		...
		<div onclick="redireccionarC('categoriasCliente.php#comedia')"  class="cat-filter col-md-4">
			<div class="card item">	
		...
		<div onclick="redireccionarC('categoriasCliente.php#danza')" class="cat-filter col-md-4">
			<div class="card item">
		...
		<div onclick="redireccionarC('categoriasCliente.php#deportes')" class="cat-filter col-md-4">
			<div class="card item">
		...
		<div onclick="redireccionarC('categoriasCliente.php#dibujo')" class="cat-filter col-md-4">
			<div class="card item">
		...
		<div onclick="redireccionarC('categoriasCliente.php#escultura')" class="cat-filter col-md-4">
			<div class="card item">
		...
		<div onclick="redireccionarC('categoriasCliente.php#graficos')" class="cat-filter col-md-4">
			<div class="card item">
		...
		<div onclick="redireccionarC('categoriasCliente.php#literatura')" class="cat-filter col-md-4">
			<div class="card item">
		...
		<div onclick="redireccionarC('categoriasCliente.php#musica')" class="cat-filter col-md-4">
			<div class="card item">
		...
		<div onclick="redireccionarC('categoriasCliente.php#cultura')" class="cat-filter col-md-4">
			<div class="card item">
		...
		<div onclick="redireccionarC('categoriasCliente.php#teatro')" class="cat-filter col-md-4">
			<div class="card item">
				...
				<div class="content-block">
					...
					<ul class="list-inline">
						...
						<li class="list-inline-item">
							<a href="nosotrosCliente.php" class="btn btn-transparent-md" >Leer mas</a>
						</li>
					</ul>
				</div>
			</div>
