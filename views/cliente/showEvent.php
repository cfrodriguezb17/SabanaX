		...
		<div class="row mt-30">
			<div class="col-lg-5 col-md-6 align-self-md-center img-showw">
				<div class="image-block img-thumbnail">
					<img src="../../upload/fotosEventos/6191b3b69a33d1.17607831.jpg" class="img-fluid" alt="speaker">
				</div>
			</div>
										...
										<div class="cat-event">
											<h5 class="widget-header">Categoria</h5>
												<ul class="list-inline">
													<li class="list-inline-item"><a href="#">Arquitectura</a></li>
												</ul>
										</div>
